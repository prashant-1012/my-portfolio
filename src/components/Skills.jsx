  ...
  return (
    <TiltCard className="col-span-1 sm:col-span-2">
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.05}
        className="h-full p-6 rounded-2xl bg-canvas-900 dark:bg-canvas-950 border border-gray-800/60 overflow-hidden relative group">
        ...
        <div className="font-mono text-sm space-y-3 bg-black/30 rounded-xl p-4 border border-white/5">
          <p className="text-gray-500">
            <span className="text-blue-400">const</span> <span className="text-emerald-400">stack</span> <span className="text-gray-500">= {'{'}</span>
          </p>
  ...
  return (
    <TiltCard className="col-span-1 sm:col-span-2">
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.1}
        className="h-full p-6 rounded-2xl bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 relative overflow-hidden group">
  ...
  return (
    <TiltCard className="col-span-1">
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.15}
        className="h-full p-6 rounded-2xl bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 overflow-hidden relative group">
...
const RealtimeCell = () => {
  const items = [
    ...
    { label: 'Socket.io',          Icon: SiSocketdotio, color: '#25c2a0' },
  ...
  return (
    <TiltCard className="col-span-1">
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.25}
        className="h-full p-6 rounded-2xl bg-canvas-900 dark:bg-canvas-950 border border-gray-800/60 relative overflow-hidden group">
...
const ToolsCell = () => {
  ...
  return (
    <TiltCard className="col-span-1 sm:col-span-2 lg:col-span-4">
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.3}
        className="h-full p-6 rounded-2xl bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 relative overflow-hidden">
        ...
        <div className="flex flex-wrap gap-3">
          {items.map(({ label, Icon, color }) => (
            <div key={label}
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-amber-300 dark:hover:border-amber-500/40 hover:shadow-sm transition-all duration-200">
