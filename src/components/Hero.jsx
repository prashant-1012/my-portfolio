    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <motion.div
          ...
          animate="visible"
          custom={0.1}
          className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 rounded-full border border-cyan-200 dark:border-cyan-800/60 bg-cyan-50 dark:bg-cyan-950/40 text-cyan-700 dark:text-cyan-400 text-sm font-medium"
        >
